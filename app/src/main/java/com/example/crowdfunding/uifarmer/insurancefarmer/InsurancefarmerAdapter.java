package com.example.crowdfunding.uifarmer.insurancefarmer;
...
class InsurancefarmerAdapter extends RecyclerView.Adapter<InsurancefarmerAdapter.MyViewHolder> {
   ...
   // int images[];
    ...
    public InsurancefarmerAdapter(Context c, int image[], String sname[], String sdesc[]) {
        this.c=c;
        images=image;
        data1 = sname;
        data2=sdesc;
