package com.example.crowdfunding.uifarmer.policiesfarmer;
...
class PoliciesfarmerAdapter extends RecyclerView.Adapter<PoliciesfarmerAdapter.MyViewHolder> {
   ...
   // int images[];
    ...
    public PoliciesfarmerAdapter(Context c, String sname[], String sdesc[]) {
        this.c=c;
        data1 = sname;
        data2=sdesc;
       // images = simage;
