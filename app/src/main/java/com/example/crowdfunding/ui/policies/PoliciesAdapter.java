package com.example.crowdfunding.ui.policies;
...
import com.example.crowdfunding.ui.policies.PoliciesAdapter;

class PoliciesAdapter extends RecyclerView.Adapter<PoliciesAdapter.MyViewHolder> {
   ...
   // int images[];
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.policies_row,parent,false);
