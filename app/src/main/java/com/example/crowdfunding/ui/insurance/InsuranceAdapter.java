package com.example.crowdfunding.ui.insurance;
...
class InsuranceAdapter extends RecyclerView.Adapter<InsuranceAdapter.MyViewHolder> {
   ...
   // int images[];
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.insurance_row,parent,false);
