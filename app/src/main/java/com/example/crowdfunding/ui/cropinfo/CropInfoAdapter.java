package com.example.crowdfunding.ui.cropinfo;
...
class CropInfoAdapter extends RecyclerView.Adapter<CropInfoAdapter.MyViewHolder> {
   ...
   // int images[];
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cropinfo_row,parent,false);
